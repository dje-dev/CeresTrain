...
{
  /// <summary>
  /// Helper class which facilitates writing 
  /// </summary>
  internal class PositionsMultipleGamesWriter
  {
    ...
    internal void WriteBlock(TarWriter tarWriter)
    {
      ...
      if (NumGamesInBuffer > 0)
      {
        ...
        string newFN = EncodedTrainingPositionRewriter.WriteToTAR(CompressionLevel, ref posBytesWritten,
                                            ...
                                            out bool extraTrainingPosWasGenerated)
    {
      ...
      int numPosReadThisGame = EncodedTrainingPositionRewriter.ExtractEncodedTrainingPositions(decompressedData, acceptGamePredicate,
