...
namespace CeresTrain.TPG
{
  ...
  internal static class TPGRecordEncoding
  {
    ...
    internal static byte ToPliesSinceLastPieceMoveBySquare(int indexMoveInGame, int indexLastMoveThisSquare)
    {
    ...
    internal static float MLHEncoded(float mlh)
    {
    ...
    internal static float MLHDecoded(float mlh) => MathF.Pow(mlh / MLH_SCALING_FACTOR, 2);
  }
