...
class Configuration:
  ...
  def __init__(self, config_files_dir : str, id : str):
    ...
    self.Opt_PyTorchCompileMode = config_opt.get('PyTorchCompileMode', None)
    ...
    self.NetDef_GlobalStreamAttentionPerSquare = config_net_def.get('GlobalStreamAttentionPerSquare', False) 
