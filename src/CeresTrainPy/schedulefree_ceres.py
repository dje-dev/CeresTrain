...
# NOTE: Minor additions made by the CeresTrain project:
#         - record the running last-used learning rate
...
class AdamWScheduleFree(torch.optim.Optimizer):
    ...
    def __init__(self,
        ...
        self.last_alpha = 0.0 # last used learning rate
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            if group['foreach'] and len(active_p) > 0:
                ...
                self.last_alpha = lr*(beta1*(1-ckp1)-1)
                torch._foreach_add_(y, grad, alpha = self.last_alpha)
